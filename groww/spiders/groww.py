...
class groww(scrapy.Spider):
    name="groww"
    start_urls=["https://groww.in/markets/top-gainers?index=GIDXNIFTY100","https://groww.in/markets/top-losers?index=GIDXNIFTY100",
    "https://groww.in/markets/top-volume?index=GIDXNIFTY100","https://groww.in/markets/top-gainers?index=GIDXNIFMDCP100",
    "https://groww.in/markets/top-losers?index=GIDXNIFMDCP100","https://groww.in/markets/top-volume?index=GIDXNIFMDCP100",
    "https://groww.in/markets/top-gainers?index=GIDXNIFSMCP100","https://groww.in/markets/top-losers?index=GIDXNIFSMCP100",
     "https://groww.in/markets/top-volume?index=GIDXNIFSMCP100","https://groww.in/mutual-funds/collections/best-high-return",
	"https://groww.in/mutual-funds/collections/best-sip-with-500","https://groww.in/mutual-funds/collections/best-tax-saving",
    "https://groww.in/mutual-funds/collections/best-large-cap","https://groww.in/mutual-funds/collections/best-mid-cap",
    "https://groww.in/mutual-funds/collections/best-small-cap"]
    ...
    def parse(self,response):
        ...
        if 'mutual-funds' in url:
            ...
            stockName=response.css('.st76SymbolName::text').extract()
            print(stockName)
            stockValue=response.css('.st76CurrVal bodyBaseHeavy::text').extract()
            print(stockValue)
            marketValue=response.css('.contentPrimary st76Pad16 bodyBase::text').extract()
            marketValueList=[]
            ...
            for k in range(min(len(stockName),len(marketValueList),len(closePrice),len(marketCap))):
            ...
            for page_number in range(1,286):
            ...
            print(stockName)
            stockValue=tr.css('td.bodyBaseHeavy::text').extract()
